  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.appHeader}>
        ...
        <Text style={styles.appText}>talki Audio...</Text>
      </View>
      ...
      <View style={styles.callActions}>
        <Pressable style={styles.callButton}>
          <View style={styles.declineButton}>
           <Image source={images.close} style={imageStyle}/>
          </View>
          <Text style={styles.callButtonText}>Decline</Text>
        </Pressable>
        <Pressable style={styles.callButton}>
          <View style={styles.acceptButton}>
            <Image source={images.check} style={imageStyle}/>
          </View>
...
export default IncomingAudioCalling