...
interface MessageListProps {
  ...
  onTotalMessagesChange?: (total: number) => void;
}

const MessageList = ({ onChatSelect, onTotalMessagesChange }: MessageListProps) => {
 ...
 useEffect(() => {
    onTotalMessagesChange?.(totalMessages);
  }, [totalMessages, onTotalMessagesChange]);
