...
const CallController = () => {
    ...
    const callOptions = [
        { icon: images.cameraflip, title: 'flip', stylee: { backgroundColor: "#958F8FCC", padding: 16, borderRadius: 50,tintColor: 'white' } },
        { icon: images.videocamera, title: 'Video', stylee: { backgroundColor: "white", padding: 16, borderRadius: 50,tintColor:'#958F8FE5' } },
